...
COPY public.sala_candidato (id, provincia, nrcandidato, nome, opcao1, opcao2, disciplina, local, sala, data) FROM stdin;
\.
...
15	Escola Francisco Mayanga	Sala A	2	1	1	35	1	f
16	Escola Secundaria de Napipine	Info B	3	1	1	35	1	f
18	Instituto Comercial da Matola	Info A	11	1	1	35	1	f
\.
...
SELECT pg_catalog.setval('public.sala_candidato_id_seq', 902, true);
...
SELECT pg_catalog.setval('public.salas_salaid_seq', 18, true);
